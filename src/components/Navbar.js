    ...
    return (
      <AppBar position="static" className="App-header">
        <Toolbar style={{ padding: 0 }}>
          ...
          >
            ...
            <span>
              { user.loaded
                ...
                : <Link to="/auth/login" className="navButton">CONTRIBUTE</Link>
              }
            </span>
          </div>
          ...
          <div style={{ display: 'flex', marginLeft: 'auto', overflow: 'auto' }}>
            { user.loaded
              ? <LoggedInBadge />
              : (
                <div style={{ display: 'flex' }}>
                  <Translate />
                  <Link to="/auth/register" className="navButton">REGISTER</Link>
                  <Link to="/auth/login" className="navButton">LOG IN</Link>
                </div>
              )
            }
          </div>
