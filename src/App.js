...
class App extends Component {
  ...
  shouldComponentUpdate(nextProps) {
    return nextProps.user.loaded !== this.props.user.loaded
  ...
  checkBrowser() {
    ...
    // Safari 3.0+
    const isSafari = /constructor/i.test(window.HTMLElement) || (p => p.toString() === '[object SafariRemoteNotification]')(!window.safari || (typeof safari !== 'undefined' && window.safari && window.safari.pushNotification))
